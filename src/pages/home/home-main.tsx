...
export const Home = () => {
    return (
        <div className = "bg-[#081014] min-h-screen flex flex-col items-center justify-center text-white p-4 relative">
            {/* slogan */}
            <button className="relative p-[2px] rounded-full bg-gradient-to-r from-[#6a5acd] via-[#836ab6] to-[#b293d3] mb-5 mt-5">
                <span className = "block bg-[#081014] rounded-full px-6 py-2">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[# ] via-[#836ab6] to-[#b293d3] font-semibold">
